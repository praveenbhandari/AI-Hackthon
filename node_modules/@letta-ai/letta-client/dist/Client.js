...
const Client_7 = require("./api/resources/embeddingModels/client/Client");
...
const Client_17 = require("./api/resources/messages/client/Client");
...
class LettaClient {
    ...
    get embeddingModels() {
        var _a;
        return ((_a = this._embeddingModels) !== null && _a !== void 0 ? _a : (this._embeddingModels = new Client_7.EmbeddingModels(this._options)));
    }
    get blocks() {
        var _a;
    ...
    get messages() {
        var _a;
        return ((_a = this._messages) !== null && _a !== void 0 ? _a : (this._messages = new Client_17.Messages(this._options)));
    }
    get voice() {
        var _a;
